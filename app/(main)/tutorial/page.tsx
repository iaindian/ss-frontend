      ...
      <div>
        ...
        <Accordion type="single" collapsible className="w-full">
          <AccordionItem value="time">
            ...
            <AccordionContent>
              Jobs are queued and processed in batches. Most packs finish within
              12–24h; you’ll get an email the moment it’s ready.
            </AccordionContent>
          </AccordionItem>
          ...
          <AccordionItem value="change-face">
            ...
            <AccordionContent>
              Yes. Upload a new headshot anytime in{" "}
              <Link href="/attributes" className="underline">
                Attributes
              </Link>
              . We’ll use the latest image for future generations.
            </AccordionContent>
          </AccordionItem>

          <AccordionItem value="credits">
            <AccordionTrigger>How can I get free credits?</AccordionTrigger>
            <AccordionContent>
              You can earn free credits by sharing your generated packs on
              social media and tagging @SuperSelfieAI. Every week, we select a
              few featured creators — winners receive bonus credits added
              directly to their account. Free and purchased credits never
              expire.
            </AccordionContent>
          </AccordionItem>
          ...
          <AccordionItem value="packs">
            <AccordionTrigger>
              My generated image is not matching with packs image
            </AccordionTrigger>
            <AccordionContent>
              We don't use face swap, we generate your image using the same
              prompt but with a fresh seed, hence the generations are unique to
              every user while maintaing the style. If you don't like the
              generated output, please contact us via{" "}
          ...
          <AccordionItem value="refund">
            ...
            <AccordionContent>
              Refunds are issued only for failed or incomplete generations. If
              you’re not satisfied with your results, reach out to us. We’ll do
              our best to find a fair and helpful solution.
            </AccordionContent>
          </AccordionItem>
          ...
          <AccordionItem value="license">
            ...
            <AccordionContent>
              Personal use & social sharing are allowed. Commercial use requires
              a license—email us if you need one.
            </AccordionContent>
          </AccordionItem>
        </Accordion>
      </div>
